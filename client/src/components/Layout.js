      ...
      <div className="app-body">
        <aside className="sidebar slide-in-left">
          ...
          <ul className="social-links">
            <li><a className="sidebar-btn" href="https://www.linkedin.com/in/anurag-sharma-bb7463318" target="_blank" rel="noopener noreferrer">LinkedIn</a></li>
            <li><a className="sidebar-btn" href="https://github.com/anurag1352" target="_blank" rel="noopener noreferrer">gitHub</a></li>
            <li><a className="sidebar-btn" href="https://www.instagram.com/anurag_s13" target="_blank" rel="noopener noreferrer">Instagram</a></li>
          </ul>
        </aside>
